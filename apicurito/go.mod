...
require (
	...
	github.com/openshift/client-go v0.0.0-20210423141557-834b073996d4 // indirect
...
// Pinned to controller-runtime 0.9.0, go 1.17
replace (
	// Version upgraded to compatibility with controller-runtime
	github.com/RHsyseng/operator-utils => github.com/RHsyseng/operator-utils v1.4.7

	// Version downgraded to preserve compatibility with controller-runtime
	github.com/go-logr/logr => github.com/go-logr/logr v0.4.0
	github.com/go-logr/zapr => github.com/go-logr/zapr v0.4.0

	// Version upgraded to compatibility with client-go and operator-utils
	github.com/openshift/api => github.com/openshift/api v0.0.0-20210423140644-156ca80f8d83
	github.com/openshift/client-go => github.com/openshift/client-go v0.0.0-20210423141557-834b073996d4
	...
	// Upgrade to compatibility with go 1.17
